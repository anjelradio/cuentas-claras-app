...
export function GoogleSignInButton() {
  ...
  return (
    <button 
      type="button" 
      className="w-full px-4 py-4 rounded-xl border border-border bg-white/5 hover:bg-white/10 transition-colors text-lg font-medium text-white flex items-center justify-center gap-3 disabled:opacity-50" 
      disabled={isPending} 
